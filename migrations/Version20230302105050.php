 ...
 */
final class Version20230302105050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE award (id INT AUTO_INCREMENT NOT NULL, competition_id INT NOT NULL, rank INT NOT NULL, INDEX IDX_8A5B2EE77B39D312 (competition_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE award_member (award_id INT NOT NULL, member_id INT NOT NULL, INDEX IDX_BF5149A13D5282CF (award_id), INDEX IDX_BF5149A17597D3FE (member_id), PRIMARY KEY(award_id, member_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE member_video_clip (member_id INT NOT NULL, video_clip_id INT NOT NULL, INDEX IDX_41F957527597D3FE (member_id), INDEX IDX_41F95752DBF40608 (video_clip_id), PRIMARY KEY(member_id, video_clip_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE member_game (member_id INT NOT NULL, game_id INT NOT NULL, INDEX IDX_DFA31DD07597D3FE (member_id), INDEX IDX_DFA31DD0E48FD905 (game_id), PRIMARY KEY(member_id, game_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
